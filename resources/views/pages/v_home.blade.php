            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 d-flex align-items-stretch">
                        <div class="content">
                            <h3>Kenapa <br>Sugar Glider kami?</h3>
                            <p>
                                Karena kami memiliki Sugar Glider kualitas terbaik dengan pencatatan silsilah terbaik dan
                                biaya adopsi terbaik.
                            </p>
                            ...
                            <div class="row">
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0">
                                        ...
                                        <h4>Kualitas</h4>
                                        <p>Kami memastikan bahwa Sugar Glider kami mendapatkan perhatian terbaik.</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0">
                                        ...
                                        <h4>Catatan Silsilah</h4>
                                        <p>Kami mencatat silsilah setiap Sugar Glider untuk mendapatkan kualitas terbaik.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0">
                                        ...
                                        <h4>Biaya</h4>
                                        <p>Kami menawarkan berbagai macam varian Sugar Glider yang kualitas terbaik dengan
