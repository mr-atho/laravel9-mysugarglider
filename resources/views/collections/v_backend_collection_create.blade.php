                                        ...
                                        <div class="col-md-8 form-group">
                                            <fieldset class="form-group">
                                                <select class="form-select" id="status" name="status"
                                                    ...
                                                    <option value="3"
                                                        @if (old('status') == '3') {{ 'selected' }} @endif>
